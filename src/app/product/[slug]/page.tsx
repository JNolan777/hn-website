      ...
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, marginTop: 32 }}>
          ...
          <div style={{ position: "relative" }}>
            <img src={product.img} alt={product.name} style={{ width: "100%", height: 450, objectFit: "cover", borderRadius: 16, border: "1px solid var(--c-border)" }} />
            {product.badge && (
          ...
          <div>
            ...
            <button
              ...
              style={{
                ...
                color: "white", border: "none", padding: "16px 40px", borderRadius: 10,
        ...
        {related.length > 0 && (
          <div style={{ marginTop: 80 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
              {related.map((p) => (
                <a key={p.id} href={`/product/${p.slug}`} style={{ textDecoration: "none", background: "white", borderRadius: 12, overflow: "hidden", border: "1px solid var(--c-border)", transition: "transform 0.3s" }}>
